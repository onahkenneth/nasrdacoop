    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title m-0">Upload Existing Ledger</h4>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-6">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title">Upload existing ledger excel file</h4>
                ...
                {!! Form::open(['route' => 'postImportInitialLedger', 'class' => '','files'=>'true']) !!}
                    <div class="m-b-30">
