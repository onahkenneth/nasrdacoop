    ...
    <div class="row">
      <div class="col-md-6">
        <div class="card text-white bg-info">
          <div class="card-body">
            <h5 class="card-title">Savings Balance: &#8358; {{ savings.bal | number_format }}</h5>
          </div>
        </div>
        <h6>Loan Details</h6>
...
export default {
  ...
  methods: {
    submitForm: function() {
      ...
      axios
        .post(`members/post-new-short-loan/${this.staff.ippis}`, this.loan)
        .then(res => {
  ...
  created() {
    this.loan.ippis = this.staff.ippis;
      axios
        .get(`members/${this.staff.ippis}/new-short-loan`, this.loan)
        .then(res => {
          // console.log(res.data);
