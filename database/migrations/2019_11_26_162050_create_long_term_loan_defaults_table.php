...
class CreateLongTermLoanDefaultsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('long_term_loan_defaults', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('long_term_loan_defaults');
    }
}
